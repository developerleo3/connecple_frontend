                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-center mb-1">
                        ...
                        <div className="flex items-center gap-4">
                            <Button onClick={() => router.push("/admin/notice/create")}
                                    className="bg-[#541E80] hover:bg-purple-700 font-bold text-white hover:cursor-pointer">
                                공지사항 작성
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div className="p-6 pb-3">
                            ...
                            <div className="mb-6 space-y-4">
                                <form onSubmit={handleSearch} className="flex gap-4">
                                    ...
                                    <Button type="submit"
                                            className="bg-[#541E80] hover:bg-purple-700 text-white font-bold hover:cursor-pointer">
                        ...
                        <Table>
                            <TableHeader className="bg-[#541E80]">
                                <TableRow>
                                    <TableHead
                                        className="text-white text-base font-medium text-center align-middle py-3">카테고리</TableHead>
                                    <TableHead
                                ...
                                {loading ? (
                                    ...
                                    notices.map((notice) => (
                                        <TableRow key={notice.id} className="hover:bg-gray-50 border-t border-gray-200">
                                            <TableCell
                                                className="text-gray-600 font-medium text-base text-center align-middle py-3">{notice.category}</TableCell>
                                            ...
                                            <TableCell
                                                className="text-gray-600 text-base text-center align-middle py-3">{formatDate(notice.createdAt)}</TableCell>
                                            <TableCell className="text-center py-3">
