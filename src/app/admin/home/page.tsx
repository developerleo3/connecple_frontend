    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (slidesResponse.ok) {
                const slidesData = await safeJson<ImageSlideResponse[] | null>(slidesResponse);
                if (Array.isArray(slidesData) && slidesData.length > 0) {
                    const mappedSlides = slidesData.map((item) => ({
                        id: item.id,
                ...
                // 404는 "없음"으로 간주하고 무시, 그 외는 에러 메시지
                setImageSlides([]);
            }
            ...
            if (statsResponse.ok) {
                const parsed = await safeJson<{ data?: StatisticData[] } | null>(statsResponse);
                const raw = parsed?.data ?? [];

                if (Array.isArray(raw) && raw.length > 0) {
                    const mappedStats = raw.map((item, index) => ({
                        id: index + 1,
            ...
            <div className="bg-gray flex-1 p-6">
                ...
                <div className="p-8 pt-0">
                  ...
                  {currentCount}/{maxCount}
                            ...
                            <div
                                className="border-3 border-dashed border-gray-300 rounded-lg p-6 mb-6 hover:cursor-pointer hover:border-[#541E80]">
                                <button
                                    ...
                                    {(provided) => (
                                        <div {...provided.droppableProps} ref={provided.innerRef}>
                                            {imageSlides.map((slide, index) => (
                                                <Draggable key={slide.id} draggableId={slide.id.toString()}
                                                           index={index}>
                                                    {(provided, snapshot) => (
                                                        <div
                                                        ...
                                                        >
                                                            <div className="flex gap-4">
                                                                ...
                                                                <div className="relative">
                                                                    <div
                                                                        className="w-[280px] h-[160px] bg-gray-100 rounded-lg overflow-hidden relative">
                                                                        {slide.image ? (
                                                                            <img
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    className="text-gray-400">이미지 없음</span>
                                                                            </div>
                                                                        )}
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <label className="cursor-pointer">
                                                                                ...
                                                                                />
                                                                                <div
                                                                                    className="bg-white text-gray-600 px-4 py-2 rounded-lg flex items-center gap-2">
                                                                                    <Plus size={16}/>
                                                                ...
                                                                <div className="flex-1">
                                                                    <div className="mb-4">
                                                                        <p className="text-sm text-gray-500 mb-1">사이즈:
                                                                            1250x720px 권장 치수입니다.</p>
                                                                        <p className="text-sm text-gray-500 mb-4">
                                                                            파일이 업로드되는 순서에 맞춰 슬라이드가 보여지며, 비율이 일정하지 않는 경우
                                                                            잘리거나 찌그러질
                                                                            수 있습니다.
                                                                        </p>
                                                                    </div>
                                    ...
                                    return (
                                        <div key={item.id} className="space-y-2">
                                            <div className="flex items-center gap-2 mb-2">
                                                <span
                                                    className="text-sm font-medium text-gray-700">통계 {index + 1}</span>
                                            </div>
